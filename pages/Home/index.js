    ...
    <section id="top" className="hero has-text-centered" style={{ backgroundColor: "#191919", minHeight: "85vh" }}>
      ...
      <div className='hero-body p-0 m-0 pt-5 pb-5' style={{ color: "#ddd", position: "relative", overflow: "hidden" }}>
        ...
        <div className="container has-text-centered">
          <h2 className="is-size-3 mt-3">PRIVATE SALE (+BONUS):<br /> Use <span style={{ color: "#edb71d" }}>BNB</span> or <span style={{ color: "#4dc491" }}>STABLES</span></h2>
          <div className="p-2" style={{ maxWidth: "300px", marginLeft: "auto", marginRight: "auto" }}>
            <ul>
              <hr className="m-2 has-background-primary" />
              <li style={{ textShadow: "0px 0px 4px black" }}>1 ATMW = $0.48 (+3% BONUS)</li>
